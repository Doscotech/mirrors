...
class EmailService:
    def __init__(self):
        ...
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Xera Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Xera — Let's Get Started "
...
<body>
  <div class="container">
    ...
    <p>Thanks again, and welcome to the Xera community <span class="emoji">🌞</span></p>

    <p>— The Xera Team</p>

    <a href="https://www.Xera.so/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Xera — we're excited to have you on board!
...
Thanks again, and welcome to the Xera community 🌞

— The Xera Team

Go to the platform: https://www.Xera.so/

---
© 2025 Xera. All rights reserved.
You received this email because you signed up for a Xera account."""
