...
import type { SubscriptionStatus } from './chat-input';
...
export const MessageInput = forwardRef<HTMLTextAreaElement, MessageInputProps>(
  (
    ...
    const renderConfigDropdown = useMemo(() => {
      if (!mounted) {
        return <div className="flex items-center gap-2 h-8" />;
      }
    ...
    }, [mounted, isLoggedIn, hideAgentSelection, selectedAgentId, onAgentSelect, selectedModel, onModelChange, modelOptions, subscriptionStatus, canAccessModel, refreshCustomModels]);
