        ...
        >
            ...
            >
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Xera uses <b>LiteLLM</b> under the hood, which makes it compatible with 100+ models. You can choose any <a href="https://openrouter.ai/models" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 underline">OpenRouter model</a> by prefixing it with <code className="bg-muted px-1.5 py-0.5 rounded text-sm font-mono">openrouter/</code> and it should work out of the box. If you want to use providers outside OpenRouter in a self-host, configure your model router accordingly and rebuild your container.
                    </DialogDescription>
