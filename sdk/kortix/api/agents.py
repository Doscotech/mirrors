...
class AgentsClient:
    """SDK client for Xpert Agents API with httpx client supporting custom headers"""
    ...
    def __init__(
        ...
        Args:
            base_url: Base URL of the API (e.g., "https://api.xera.cc/api")
...
client = create_agents_client(
    base_url="https://api.xera.cc/api",
