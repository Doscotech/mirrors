...
export default function AgentConfigScreen() {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      // ...other tabs (instructions, tools, integrations, knowledge) are rendered below in the unchanged content
      default:
        return (
          <ScrollView contentContainerStyle={styles.scrollContent}>
            <Text style={{ color: styles.hint.color }}>Tab content</Text>
          </ScrollView>
        );
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabBarContainer}>
        <View style={styles.tabBar}>
          ...
          <TouchableOpacity style={[styles.tab, activeTab === 'instructions' && styles.activeTab]} onPress={() => setActiveTab('instructions')}>
            <Text style={[styles.tabText, activeTab === 'instructions' && styles.activeTabText]}>Instructions</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.tab, activeTab === 'tools' && styles.activeTab]} onPress={() => setActiveTab('tools')}>
            <Text style={[styles.tabText, activeTab === 'tools' && styles.activeTabText]}>Tools</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.tab, activeTab === 'integrations' && styles.activeTab]} onPress={() => setActiveTab('integrations')}>
            <Text style={[styles.tabText, activeTab === 'integrations' && styles.activeTabText]}>Integrations</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.tab, activeTab === 'knowledge' && styles.activeTab]} onPress={() => setActiveTab('knowledge')}>
            <Text style={[styles.tabText, activeTab === 'knowledge' && styles.activeTabText]}>Knowledge</Text>
          </TouchableOpacity>
        </View>
      </View>
