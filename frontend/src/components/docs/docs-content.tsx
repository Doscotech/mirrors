...
const contentSections = [
  {
    id: 'introduction',
    title: 'Introduction',
  description: 'Learn about Xera and how it orchestrates autonomous AI Workers for your workflows',
    readTime: '5 min read',
    updated: '2 days ago'
  },
  {
  ...
  },
  {
    id: 'installation',
    title: 'Installation',
  description: 'Step-by-step guide to set up your workspace, connect tools, and launch agents in Xera',
          ...
          <div className="max-w-4xl mx-auto px-4 lg:px-8 py-6 lg:py-12">
            <div className="mb-12">
              ...
              <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-3xl">
                ...
                Xera is a SaaS platform—focus on outcomes while we handle scaling, observability, and reliability.
              </p>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mt-6">
                 ...
                 {/* GitHub link removed for SaaS docs */}
               </div>
            </div>
