                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY Xera, Inc.
                      (based in Arlington, Texas, United States). THIS AGREEMENT
                      SETS FORTH THE LEGALLY BINDING TERMS AND CONDITIONS FOR YOUR
                      USE OF THE XERA WEBSITE AND ALL RELATED SERVICES.
                    </p>
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>
                        ...
                        Company, specifically legal@xera.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Xera is provided as a hosted service. Unless otherwise agreed in a separate written agreement with the Company, your use of the Service is governed solely by these Terms. No open-source license applies to the Service.
                    </p>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@xera.ai and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@xera.ai. If you cancel
